export default {
  ...
  'sessions.active.section': 'Unarchived',
  ...
  'mode.permission.updated.title': 'Permission mode updated',
  'mode.permission.updated.immediate': 'Switched to {mode}. New permission requests will follow this mode.',
  'mode.permission.updated.nextRequest': 'Switched to {mode}. Existing prompts stay manual; new requests will follow this mode.',
  'mode.model.updated.title': 'Model updated',
  'mode.model.updated.body': 'Switched to {mode}. It will apply from the next turn.',
  'mode.reasoning.updated.title': 'Reasoning level updated',
  'mode.reasoning.updated.body': 'Switched to {effort}. It will apply from the next turn.',
  'mode.permission.default': 'Default',
  ...
  'mode.model.default': 'Default',
  'mode.model.sonnet': 'Sonnet',
  'mode.model.opus': 'Opus',
  'mode.reasoning.auto': 'Auto',
  'mode.reasoning.low': 'Low',
  'mode.reasoning.medium': 'Medium',
  'mode.reasoning.high': 'High',
  'mode.reasoning.xhigh': 'XHigh',
