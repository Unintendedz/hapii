export default {
  ...
  'settings.about.buildVersion': '构建版本',
  'settings.about.protocolVersion': '协议版本',

  // Mode change feedback
  'mode.permission.updated.title': '权限模式已更新',
  'mode.permission.updated.immediate': '已切换到 {mode}，新的权限请求将按此模式处理。',
  'mode.permission.updated.nextRequest': '已切换到 {mode}；当前已弹出的权限请求仍需手动处理，后续请求将按新模式处理。',
  'mode.model.updated.title': '模型已更新',
  'mode.model.updated.body': '已切换到 {mode}，将从下一轮对话开始生效。',
  'mode.reasoning.updated.title': '推理级别已更新',
  'mode.reasoning.updated.body': '已切换到 {effort}，将从下一轮对话开始生效。',
  'mode.permission.default': '默认',
  ...
  'mode.model.default': '默认',
  'mode.model.sonnet': 'Sonnet',
  'mode.model.opus': 'Opus',
  'mode.reasoning.auto': '自动',
  'mode.reasoning.low': '低',
  'mode.reasoning.medium': '中',
  'mode.reasoning.high': '高',
  'mode.reasoning.xhigh': '极高',
